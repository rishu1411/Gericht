...
export default function TextField({ type, placeholder,helperText,error,value,before,after,children }) {
  return (
    <>
    ...
    hover:ring-1 hover:ring-white focus-within:hover:ring-golden  rounded-xl`}>
      ...
      <label htmlFor="" className={`flex gap-x-2 font-base`}>
        ...
        <input type={type} placeholder={placeholder} value={value} className={`bg-transparent outline-none w-full px-2` }/>
        {
